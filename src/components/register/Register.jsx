...
// // API Configuration
// const API_BASE_URL = "https://nutriscan-foodanddrinksupply.onrender.com"; // Your Node.js backend URL
...
// // Cookie helpers (matching your backend)
...
//         role: formData.role,
//         // Note: isActive defaults to true in schema
//         // createdAt and updatedAt are auto-managed by timestamps: true
//         // lastLogin will be null initially
//       };
...
//         // Store token in cookie (matching your backend)
//         if (token) {
...
//       if (error.response) {
//         // Handle duplicate email error (schema unique: true)
//         if (
...
//               {/* Name Field - matches schema: required, min 2, max 50 */}
//               <div>
...
//               {/* Email Field - matches schema: unique, lowercase, regex validated */}
//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-1">
...
//               {/* Role Selection - matches schema enum: ['manager', 'chef', 'staff'] */}
//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-1">
...
//               {/* Password Field - matches schema: required, min 6 */}
//               <div>
//                 <label className="block text-sm font-medium text-gray-700 mb-1">
